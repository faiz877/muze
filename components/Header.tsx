    ...
    <header className="flex items-center justify-between px-4 py-3 bg-[#F6F6F6]" role="banner">
      <div className="flex items-center flex-1">
        <div className="flex items-center gap-2 ml-25">
          <Link href="/" aria-label="Go to Muze homepage" className="flex items-center gap-2">
            <Image
              src="/muze-logo-3.svg"
              alt="Muze logo"
              width={20}
        ...
        <div className="relative mx-auto w-[300px] ml-105" role="search">
          <input
            type="text"
            role="searchbox"
      ...
      <div className="flex items-center gap-4 mr-25">
        ...
        <button 
          ...
          className="cursor-pointer transform transition-transform duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-500/40 rounded-full"
        >
          <Image
            src="/profile2.jpg"
